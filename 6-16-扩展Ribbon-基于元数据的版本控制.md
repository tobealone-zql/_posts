...
title: 6-16-扩展Ribbon-基于元数据的版本控制
...
![image-20210308223026338](6-16-扩展Ribbon-基于元数据的版本控制/image-20210308223026338.png)



## 2. 创建NacosFinalRule配置类
...
import com.zql.contentCenter.configuration.NacosFinalRule;
...
## 4. 修改content-center application.yml
